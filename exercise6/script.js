//  identify our elements that will be involved in the interaction
...
let images = document.querySelectorAll(".slide__container img"); //an array
...
let counter = 4;
//repositions an element horizontally on the 2D plane.
...
nextButton.addEventListener("click", () => {
  ...
  // adjust the transition timing to 1s
  slideContainer.style.transition = "1s ease-in-out"; // transitioning should happen with a 0.25s long transition
...
//detect when a transition has finished (that means that we arrived to a new slide):
